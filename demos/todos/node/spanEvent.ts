// spanEvent.ts
import { trace, Attributes, Span, TimeInput } from "@opentelemetry/api";
...
const minLevel: Level = (() => {
  const raw = (process.env.EVENTS_LOG_LEVEL ?? "INFO").toUpperCase();
  return (Level as any)[raw] ?? Level.INFO;
})();
